...
const renderThreads = (threads) => {
  ...
  return `
    <section class="threads">
      <div class="threads-h">持续追踪</div>
      ${threads.map(row).join("")}
    </section>`;
};

// 栏目顺序：Perp DEX 第一，再 Launchpad、Crypto、AI，最后「机会与打法」收尾。
...
// 机会与打法栏(hertzflow)是研判综述、可引用较老来源，不渲染日期，避免页面显示老日期被误读为旧闻。
